          ...
          <table className="price-table">
            <tbody>
              ...
              <tr>
                <td />
                <td className="price">
                  <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 128 128" style={{display:'inline'}}>
                    <defs />
                  ...
                  <br />Free
                  <br />
                 <button className="btn_pricing temp_btn" style={{fontSize:'77%', fontWeight:'500'}} onClick={free}>Get started</button>
                ...
                <td className="price">
                  ...
                  <br />
                  {authtoken && 
                  <button onClick={submit} style={{fontSize:'77%', fontWeight:'500'}} className="btn_pricing temp_btn">Get started</button>}
                ...
                <td className="price">
                  ...
                  <br />
                  {authtoken && 
                  <button onClick={submit2} style={{fontSize:'77%', fontWeight:'500'}} className="btn_pricing temp_btn">Get started</button>}
                  {!authtoken && <button onClick={login} className="btn_pricing temp_btn">Get started</button>}
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td><a href="#wordpress-priority-support" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> 24/7 Support</td>
                <td><CheckIcon/></td>
                <td><CheckIcon/></td>
                <td><CheckIcon/></td>
              </tr>
              <tr>
                <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Easy Billing + No Contracts</td>
                <td><CheckIcon/></td>
                <td><CheckIcon/></td>
                <td><CheckIcon/></td>
              </tr>
